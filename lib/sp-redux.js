...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js__ = __webpack_require__(5);
...
const actionCreator = {
    fetchUser: accountName => (dispatch, getState) => {
        ...
        __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js__["sp"].profiles.getPropertiesFor(accountName).then(profile => dispatch(new UserAction(accountName, __WEBPACK_IMPORTED_MODULE_2__asyncActionType__["a" /* AsyncActionType */].Response, profile)));
    }
};
